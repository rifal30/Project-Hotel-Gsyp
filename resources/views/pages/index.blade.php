...
<div id="page">
            ...
            <div id="myCarousel1" class="carousel slide" data-ride="carousel"> 
                ...
                <a class="right carousel-control" href="#myCarousel1" data-slide="next"><img src="/assets/images/icons/right-arrow.png" onmouseover="this.src = '/assets/images/icons/right-arrow-hover.png'" onmouseout="this.src = '/assets/images/icons/right-arrow.png'" alt="right"></a>
                            ...
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="item">
                                    ...
                                    <div class="blog-view-box">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="/assets/images/client3.png" class="media-object">
                                            </div>
                                            <div class="media-body">
